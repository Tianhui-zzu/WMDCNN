...
def draw_confusion_matrix(confusion_matrix):
    ...
    plt.xticks(range(len(confusion_matrix_normalization)), ['NH3', 'H2S', 'CS2', 'CS2_NH3','H2S_NH3','CS2_H2S'])
    plt.yticks(range(len(confusion_matrix_normalization)), ['NH3', 'H2S', 'CS2', 'CS2_NH3','H2S_NH3','CS2_H2S'])
...
if __name__ == '__main__':
    ...
    testData = get_testData(batch_size=8, data_x=X_test + X_train, data_y=y_test + y_train)
    model.eval()
