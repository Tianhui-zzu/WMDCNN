...
import pandas as pd
from learnner import get_customized_schedule_with_warmup
...
print_batch = 36
lr = 0.0001
warmup_steps = 1000  # warmup_steps扩大w倍，要保持整个过程学习率极值不改变，对应learnner中的factor要扩大w**0.5倍
...
if __name__ == '__main__':
    ...
    model = HATN_DA()
    # model.load_state_dict(torch.load('MST_CNN0.72.pth'))
    ...
    steps = len(train_loader.dataset) * epochs / bs
    optim = optim.Adam(model.parameters(), lr=lr, betas=(0.9, 0.98), eps=1e-9)
