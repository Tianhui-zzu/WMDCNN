...
class MST_AAMN(nn.Module):
    def __init__(self, memory_t=None, memory_f=None):
        ...
        self.F_E_C1 = Feature_Extractor(input_dim, C1_S, sensor_num=9, dropout=0.1, head=4)
        self.F_E_C2 = Feature_Extractor(input_dim, C2_S, sensor_num=9, dropout=0.1, head=4)
        self.F_E_C3 = Feature_Extractor(input_dim, C3_S, sensor_num=9, dropout=0.1, head=4)
